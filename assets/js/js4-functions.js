...
lufthansa.book(239, 'Rufaro Haruperi');
...
// Apply method
// (does the same but takes an array of data) ***used less
const flightData = [583, 'George Cooper'];
book.apply(swiss, flightData);
console.log(swiss);

book.call(swiss, ...flightData);  // ***used more
