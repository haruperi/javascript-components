...
const dataTypesLevel3 = () => {
 console.log((love.match(/love/g)|| []).length)
 console.log((because.match(/because/g) || []).length)
 console.log(sentence4.replace(/[^a-zA-Z\s,.]/g,''))
 const salaryArr = salary.match(/\d+/g)
 salary = parseInt(salaryArr[0]*12) + parseInt(salaryArr[1]) + parseInt(salaryArr[2]*12)
 console.log(salary)
}

export {dataTypesLevel1, dataTypesLevel2, dataTypesLevel3}